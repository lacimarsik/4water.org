...
if ($form_submitted) {
	...
	if (isset($_POST['submitform'])) {
		...
		foreach ($prices_array as $price_id => $count) {
			// Convenience map of price types (Prague) to avoid additional SQL. Falls back to price type ID.
			$humanized_price_type = $price_id;
			switch (intval($price_id)) {
				case 39:
					$humanized_price_type = 'Student 1x';
					break;
				case 40:
					$humanized_price_type = 'Non-Student 1x';
					break;
				case 41:
					$humanized_price_type = 'Student Voucher';
					break;
				case 42:
