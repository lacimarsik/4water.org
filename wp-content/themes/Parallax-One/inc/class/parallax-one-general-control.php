...
class Parallax_One_General_Repeater extends WP_Customize_Control {
  ...
  private function render_box(
          $icon, 
          $it, 
          $parallax_image_control,
          $parallax_icon_control,
          $parallax_title_control,
          $parallax_subtitle_control,
          $parallax_video_url_control,
          $parallax_text_control,
          $parallax_link_control) {
    ?>
    <div class="parallax_one_general_control_repeater_container parallax_one_draggable">
      <div class="parallax-customize-control-title">
        <?php esc_html_e('Entry '.($it + 1),'parallax-one')?>
      </div>
      <div class="parallax-box-content-hidden">
        ...
        if ($parallax_image_control == true && $parallax_icon_control == true) { ?>
          ...
          <select class="parallax_one_image_choice">
            <option value="parallax_icon" <?php selected($icon->choice,'parallax_icon');?>>
              <?php esc_html_e('Icon','parallax-one');?>
            </option>
            <option value="parallax_image" <?php selected($icon->choice,'parallax_image');?>>
              <?php esc_html_e('Image','parallax-one');?>
            </option>
            <option value="parallax_none" <?php selected($icon->choice,'parallax_none');?>>
          ...
          <p class="parallax_one_image_control"  <?php if(!empty($icon->choice) && $icon->choice!='parallax_image'){ echo 'style="display:none"';}?>>
            ...
            <input 
                ...
                value="<?php if(!empty($icon->image_url)) {echo esc_attr($icon->image_url);} ?>">
            <input 
                type="button" 
        ...
        if($parallax_title_control==true) { ?>
          ...
          <input 
              type="text" 
              value="<?php if(!empty($icon->title)) echo esc_attr($icon->title); ?>" 
              class="parallax_one_title_control" 
              placeholder="<?php esc_html_e('Title','parallax-one'); ?>"/>
          <?php
        }
        ...
        if($parallax_subtitle_control==true) { ?>
          ...
          <input 
              type="text" 
              value="<?php if(!empty($icon->subtitle)) echo esc_attr($icon->subtitle); ?>" 
              class="parallax_one_subtitle_control" 
              placeholder="<?php esc_html_e('Subtitle','parallax-one'); ?>"/>
          <?php
        }
        ...
        if($parallax_video_url_control==true) { ?>
          ...
          <input 
              type="text" 
              value="<?php if(!empty($icon->video_url)) echo esc_attr($icon->video_url); ?>" 
              class="video_url" 
              placeholder="<?php esc_html_e('Video embed URL','parallax-one'); ?>"/>
          <?php
        }
        ...
        if($parallax_link_control){ ?>
          ...
          <input 
              type="text" 
              value="<?php if(!empty($icon->link)) echo esc_url($icon->link); ?>" 
        ...
        <button 
            ...
            <?php if ($it == 0) echo 'style="display:none;"'; ?>>
    ...
    <div class="parallax_one_general_control_repeater parallax_one_general_control_droppable">
      ...
      if (!empty($json)) {
        foreach ($json as $icon){
          $this->render_box($icon, $it, $parallax_image_control, $parallax_icon_control, $parallax_title_control, $parallax_subtitle_control, $parallax_video_url_control, $parallax_text_control, $parallax_link_control);
          $it++;
        }
      } 
