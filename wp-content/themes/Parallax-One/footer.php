                ...
                if( !empty( $parallax_one_social_icons ) ){
                  ...
                  if( !empty($parallax_one_social_icons_decoded) ){
                    ...
                    foreach($parallax_one_social_icons_decoded as $parallax_one_social_icon){
                      ...
                      echo '<li><a target="_blank" href="'.esc_url($parallax_one_social_icon->link).'"><span class="'.esc_attr($parallax_one_social_icon->icon_value).' transparent-text-dark"></span></a></li>';
...
<?php
          ...
          echo '<div class="row footer-policy"><a href="http://4water.org/privacy-policy">Privacy Policy</a></div>';
